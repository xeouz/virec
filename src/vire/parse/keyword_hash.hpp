...
/* Command-line: gperf -CGD -L C++ -N hash_keyword_to_token -K Keyword -t keywords.gperf  */
...
public:
  static const struct KeywordCode *hash_keyword_to_token (const char *str, size_t len);
};
